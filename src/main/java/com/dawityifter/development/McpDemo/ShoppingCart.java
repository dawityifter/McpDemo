package com.dawityifter.development.McpDemo;
...
public class ShoppingCart {
    ...
    @Tool(name = "addItem", description = "Add an item to the shopping list or update its quantity. Specify item name and quantity.")
